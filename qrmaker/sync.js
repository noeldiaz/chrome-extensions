// Optional cross-device sync (workspace convention; see also theme.js / i18n.js).
//
...
// (the flag, theme, the pageScan session handoff, and the saved logos — large
// image dataURLs kept in IndexedDB) keeps using its own local storage directly.
