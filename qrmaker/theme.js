// Shared light/dark theme wiring for every QRmaker page. A page calls
// initTheme() with its toggle button + moon/sun icons; the choice is stored in
// chrome.storage.local ("theme": "dark" | "light", or unset = follow the OS) and
// the .dark class on <html> is kept in sync. Mirrors the popup-only theme
// pattern used across the workspace extensions.
